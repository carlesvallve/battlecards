import { CardType, Affliction } from 'src/types/custom';
...
// playables
- reshuffle hand
- change all cards for random modifiers
*/
...
const cards = {
  ...
  axe: {
    ...
    desc: '',
    ep: 10,
    katana: 'brokenarmour' as Affliction,
  },
