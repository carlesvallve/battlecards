...
export default class InputView extends View {
  ...
  onInputMove (evt, pt) {
    ...
    if (this.lastStartID === INVALID || Math.sqrt(dx * dx + dy * dy) >= this.dragThreshold) {
      this.handleDrag(
        x - startPt.lastX,
        y - startPt.lastY
      );
